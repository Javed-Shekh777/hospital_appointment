              ...
              <div class="row my-appointment-item gy-3">
                <div class="col-lg-10  ">
                    <div class="my-appointment-left gx-2">
                        ...
                        <div class="my-appointment-info">
                            ...
                            <p><h5>Date & Time:</h5> {{ \Carbon\Carbon::parse($appointment->slot->date)->format('d, F, Y') }} | {{ \Carbon\Carbon::parse($appointment->slot->time)->format('g:i A') }}</p>
                ...
                <div class="col-lg-2   appointment-btns">
                    <div class="btns">
                        ...
                        <a href="#"  class="pay pay-appointment mb-2" style="display: none;">Razorpay</a>
                        <a href="#" class="pay pay-appointment mb-2" style="display: none;">Stripe</a>

                        <a href="{{route('cencel-appointment',$appointment->id)}}" class="cencel-appointment ">Cancel appointment</a>
                    </div>
                </div>
            </div>
            <div class="horizontal"></div>
